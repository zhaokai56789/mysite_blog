...
from read_statistics.utils import get_max_read_num
...
# 获取热门博客的缓存数据
# def get_hot_blog_cache():
#     get_max_read_num = cache.get('get_max_read_num')
#     if get_max_read_num is None:
#         get_max_read_num = get_max_read_num
#         cache.set('get_max_read_num', get_max_read_num, 3600)
#     return get_max_read_num
...
def get_blog_list_common_data(request, blogs_all_list):
    ...
    context = {}
    context['blogs'] = blogs
    context['all_blog'] = Blog.objects.all()
